...
# ☕ OpenWrt with latest NodeJs and Redis
...
There were some changes. So this is how it works with ```18.06.2```.
...
[**P3X-OPENWRT-INSOMNIA**](https://pages.corifeus.com/openwrt-insomnia) Build v2019.3.3-2 
