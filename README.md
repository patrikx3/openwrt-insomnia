...
* Linksys WRT1900ACS / Linksys WRT3200ACM / Linksys WRT32X
  ...
  * https://cdn.corifeus.com/openwrt/ or specific version eg. https://cdn.corifeus.com/openwrt/21.02.0-rc2/targets/mvebu/cortexa9/
...
<!--
* D-Link DIR-860l B1 
  * https://cdn.corifeus.com/openwrt/21.02.0-rc2/targets/ramips/mt7621/
...
* RPI-3
  * https://cdn.corifeus.com/openwrt/ or specific version eg. https://cdn.corifeus.com/openwrt/21.02.0-rc2/targets/brcm2708/bcm2710/
...
```text
src/gz openwrt_node http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/arm_cortex-a9_vfpv3/node
```

The rest, you can find on OpenWrt as well, so you do not need it:
```text
src/gz openwrt_core http://cdn.corifeus.com/openwrt/21.02.0-rc2/targets/mvebu/cortexa9/packages
src/gz openwrt_base http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/arm_cortex-a9_vfpv3/base
src/gz openwrt_luci http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/arm_cortex-a9_vfpv3/luci
src/gz openwrt_packages http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/arm_cortex-a9_vfpv3/packages
src/gz openwrt_routing http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/arm_cortex-a9_vfpv3/routing
src/gz openwrt_telephony http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/arm_cortex-a9_vfpv3/telephony
```
...
What is very useful is (many NodeJs built packages as well as binary builds):
```text
src/gz openwrt_node http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/mipsel_24kc/node
```

The rest, you can find on OpenWrt as well, so you do not need it:
```text
src/gz openwrt_core http://cdn.corifeus.com/openwrt/21.02.0-rc2/targets/ramips/mt7621/packages
src/gz openwrt_base http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/mipsel_24kc/base
src/gz openwrt_luci http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/mipsel_24kc/luci
src/gz openwrt_packages http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/mipsel_24kc/packages
src/gz openwrt_routing http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/mipsel_24kc/routing
src/gz openwrt_telephony http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/mipsel_24kc/telephony
```
...
What is very useful is (many NodeJs built packages as well as binary builds):
```text
src/gz openwrt_node http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/aarch64_cortex-a53/node
```

The rest, you can find on OpenWrt as well, so you do not need it:
```text
src/gz openwrt_core http://cdn.corifeus.com/openwrt/21.02.0-rc2/targets/brcm2708/bcm2710/packages
src/gz openwrt_base http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/aarch64_cortex-a53/base
src/gz openwrt_luci http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/aarch64_cortex-a53/luci
src/gz openwrt_packages http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/aarch64_cortex-a53/packages
src/gz openwrt_routing http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/aarch64_cortex-a53/routing
src/gz openwrt_telephony http://cdn.corifeus.com/openwrt/21.02.0-rc2/packages/aarch64_cortex-a53/telephony
```
-->
